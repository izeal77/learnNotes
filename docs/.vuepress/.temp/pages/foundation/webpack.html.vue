<template><h3 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack" aria-hidden="true">#</a> webpack</h3>
<h4 id="_1-概念" tabindex="-1"><a class="header-anchor" href="#_1-概念" aria-hidden="true">#</a> 1.概念</h4>
<p>静态模块打包工具</p>
<p>模块化：webpack可以让我们进行模块化开发，自动处理相关依赖关系，</p>
<p>打包：文件压缩合并、预处理等功能</p>
<p>和grunt、gulp区别：</p>
<p>前者更强调流程的自动化，定义一些任务等，核心不是模块化</p>
<p>后者更强调模块化的开发管理</p>
<h4 id="_2-使用" tabindex="-1"><a class="header-anchor" href="#_2-使用" aria-hidden="true">#</a> 2.使用</h4>
<p>以webpack打包commonJS为例，先在各个模块写代码，使用commonJS的module.export{}和const xxx = require('xxx.js')各自依赖，最后用webpack打包好，在index.html中引用这个打包好的文件</p>
<p>只需要打包入口文件，会自动处理相关依赖；</p>
<p><code>webpack ./src/main.js ./dist/bundle.js</code>对应的是入口文件和打包后存放的地方</p>
<h4 id="_3-详解" tabindex="-1"><a class="header-anchor" href="#_3-详解" aria-hidden="true">#</a> 3.详解</h4>
<p>模块化：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>2.npm init -y初始化webpack，即可使用webpack快捷打包</p>
<p>3.将webpack映射到npm run build(优先执行本地webpack)</p>
...
<p>需要npmloader：css-loader和style-loader</p>
<p>css-loader负责加载css文件，不负责将css嵌入文档中</p>
<p>style-loader负责将样式添加到DOM中</p>
<p>步骤二：在webpack.config.js中的modules关键字下进行配置</p>
<p>步骤三：在main.js中引用css文件</p>
<p><strong>加载图片</strong></p>
<p>对于使用url的图片，会存在打包后访问不到的问题，可以去webpack.config.js中加上：publicPath:'dist/'，因为打包后的路径相对于之前改变了</p>
...
<p>在webpack中，我们直接使用babel对应的loader就可以了</p>
<p>安装npm install --save-dev babel-loader@7 babel-core babel-preset-es2015</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
      <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p><strong>配置Vue</strong></p>
<p>几个问题：</p>
<p>使用runtime-only版本的vue，会报错，修改webpack的配置</p>
<p>el和template模板的关系是什么呢？</p>
<p>el用于指定Vue要管理的DOM，可以帮助解析其中的指令、事件监听等等。</p>
<p>而如果Vue实例中同时指定了template，那么template模板的内容会替换掉挂载的对应el的模板。</p>
<p>webpack打包vue的时候会报错，需要安装vue-loader和vue-template-compiler，并且修改webpack.config.js文件。并且把vue-loader版本改为：&quot;vue-loader&quot;: &quot;^13.0.0&quot;,</p>
<h5 id="plugin" tabindex="-1"><a class="header-anchor" href="#plugin" aria-hidden="true">#</a> plugin</h5>
<p>loader主要用于转换某些类型的模型，是一个转换器</p>
<p>plugin是插件，是对webpack本身的扩展，是一个扩展器</p>
</template>
